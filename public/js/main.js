(function ($) {
  ...
  $(document).ready(function () {
    ...
    // ========================= Top Brand Slider is now handled by React Component ===================
    // The top-brand__slider is now using React Slick in the Brand component
    // jQuery initialization removed to avoid conflicts
  ...
  //     // Get actual header height before making it fixed
  //     var headerHeight = $('.header').outerHeight();
  //     $('.header').addClass('fixed-header');
  //     $('body').addClass('header-fixed').css('margin-top', headerHeight + 'px');
  //   }
  //   else {
  //     $('.header').removeClass('fixed-header');
  //     $('body').removeClass('header-fixed').css('margin-top', '0');
  //   }
  // });
